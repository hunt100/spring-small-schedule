                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                ...
                                <p class="category">Add New Teacher</p>
                            </div>
                            <div class="content">

                                <form action="/addTeacher" method="post">
                                    <h5>Last name:</h5>
                                    <input type="text" name="lname" class="form-control" placeholder="Teacher last name"/>
                                    <br>
                                    <h5>First name:</h5>
                                    <input type="text" name="fname" class="form-control" placeholder="Teacher first name"/>
                                    <br>
                                    <h5>Degree:</h5>
                                    <input type="text" name="degree" class="form-control" placeholder="Teacher's degree"/>
                                    <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="header">
                                            <h4 class="title">Show all Teachers</h4>
                                            <p class="category">Only the best will become gods </p>
                                        </div>
                                        <div class="content">
                                            <table class="table">
                                                <thead>
                                                ...
                                                <c:forEach var="teacher" items="${teachers}">
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-primary" href="/editTeacher/${teacher.id}" role="button">Edit</a></td>
                                                        <td><form action="/deleteTeacher" method="post" style="margin: 0px;padding: 0px;">
