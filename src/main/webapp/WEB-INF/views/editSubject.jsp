                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Edit current subject</h4>
                                <p class="category">Your subject: ${subject.subjectName}</p>
                            </div>
                            <div class="content">

                                <form action="/editSubjectPost" method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Subject's credits: </label>
                                        <input type="text" name="credits" class="form-control" value="${subject.credits}"/>
                                    </div>
